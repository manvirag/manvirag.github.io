...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (( pathParts[1] === 'writing' ||  pathParts[1] === 'lifewriting') && pathParts.length === 3) {
      setIsBlogDetail(true); // Set to true if it's /writing/:id
    } else {
  ...
  return (
    // <Router>
      <div className="app-container">
        ...
        <Sidebar isBlogDetail={isBlogDetail}/> {/* Use the Sidebar component here */}
        ...
        <div className="content">
          <Routes>
            ...
            <Route path="/writing/:id" element={<BlogDetail blogData={blogData} markdown = {"blog"}/>} />
            <Route path="/lifewriting/:id" element={<BlogDetail blogData={lifeblog} markdown = {"lifeblog"}/>} />
          </Routes>
        </div>
      </div>
    // </Router>
